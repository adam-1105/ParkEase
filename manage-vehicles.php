<?php
	...
	if(isset($_POST['submit-vehicle'])) {
		$parkingnumber=$_POST['parkingslot'];
						...
						<div class="col-md-12">
							...
							<form method="POST">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="JGL-1869" id="vehreno" name="vehreno" required>
								</div>
								...
								<div class="form-group">
									<label>Preferred Parking Slot</label>
									<input type="text" class="form-control" placeholder="A1,A2,A3... B1,B2,B3... C1,C2,C3..." id="parkingslot" name="parkingslot" required>
								</div>
