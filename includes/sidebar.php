<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			<div class="profile-userpic">
				<img src="includes\icon_admin.png" width="50" class="img-responsive" alt="Icon">
			</div>
			<div class="profile-usertitle">
				<div class="profile-usertitle-name">Adam</div>
		...
		<ul class="nav menu">
			...
			<li class="<?php if($page=="delete-vehicles") {echo "active";}?>"><a href="delete-vehicles.php"><em class="fa fa-car">&nbsp;</em> Delete Vehicles Data</a></li>
